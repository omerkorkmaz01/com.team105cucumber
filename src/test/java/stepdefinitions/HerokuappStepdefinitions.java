...
public class HerokuappStepdefinitions {
    ...
    public void delete_butonu_gorunur_oluncaya_kadar_bekler() throws InterruptedException {
        Thread.sleep(2000);
        // aslinda beklemeye gerek, ama bekler dedigi icin 2 sn bekler
    }
    @Then("Delete butonun gorunur oldugunu test eder")
    public void delete_butonun_gorunur_oldugunu_test_eder() {
